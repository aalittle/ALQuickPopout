...
@interface ALModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation ALModelController
...
{   
    ...
    ALDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"ALDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(ALDataViewController *)viewController];
